...
/* package insituc-0.1.0.0 */
#ifndef VERSION_insituc
#define VERSION_insituc "0.1.0.0"
#endif /* VERSION_insituc */
#ifndef MIN_VERSION_insituc
#define MIN_VERSION_insituc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_insituc */
...
#define CURRENT_COMPONENT_ID "insituc-0.1.0.0-inplace-insituc"
